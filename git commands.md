...
![rebase 1](img/basic-rebase-1.png)

pic 35: История коммитов простого разделения

![rebase 2](img/basic-rebase-2.png)
...
![rebase 3](img/basic-rebase-3.png)
...
![rebase 4](img/basic-rebase-4.png)
...
![advanced rebase](img/interesting-rebase-1.png)
...
![advanced rebase](img/interesting-rebase-2.png)
...
![advanced rebase](img/interesting-rebase-3.png)
...
![advanced rebase](img/interesting-rebase-4.png)
...
![advanced rebase](img/interesting-rebase-5.png)
...
![perils-of-rebasing 1](img/perils-of-rebasing-1.png)

pic 44: Клонирование репозитория и выполнение в нем какой-то работы

![perils-of-rebasing 2](img/perils-of-rebasing-2.png)
...
![perils-of-rebasing 3](img/perils-of-rebasing-3.png)
...
![perils-of-rebasing 4](img/perils-of-rebasing-4.png)
...
![perils-of-rebasing 5](img/perils-of-rebasing-5.png)
...
Удаленный репозиторий — это обычно голый (чистый, bare) репозиторий ― репозиторий Git, не имеющий рабочего каталога. Поскольку этот репозиторий используется только для обмена, то нет причин создавать рабочую копию файлов на диске, и он содержит только данные Git.
...
## 5 Распределенный Git - Distributed Workflows

### Centralized Workflow

![centralized_workflow](img/centralized_workflow.png)
...
![integration-manager](img/integration-manager.png)
...
![benevolent-dictator](img/benevolent-dictator.png)
...
[Contributing to a Project](https://git-scm.com/book/ru/v2/Распределенный-Git-Contributing-to-a-Project)
...
![small-team-1](img/small-team-1.png)

pic 58: John’s divergent history.

`git merge origin/master`

![small-team-2](img/small-team-2.png)

pic 59: John’s repository after merging origin/master.

`git push origin master`

![small-team-3](img/small-team-3.png)
...
![small-team-4](img/small-team-4.png)

pic 61: Jessica’s topic branch.

`git fetch origin`

![small-team-5](img/small-team-5.png)
...
![managed-team-1](img/managed-team-1.png)
...
![managed-team-2](img/managed-team-2.png)
...
Integrators
essica, Josie, and John inform the integrators that the featureA and featureBee branches on the server are ready for integration into the mainline. After the integrators merge these branches into the mainline, a fetch will bring down the new merge commit, making the history look like this:

![managed-team-3](img/managed-team-3.png)
...
![managed-team-flow](img/managed-team-flow.png)
...
![public-small-1](img/public-small-1.png)
...
![public-small-2](public-small-2.png)
...
![public-small-3](img/public-small-3.png)
